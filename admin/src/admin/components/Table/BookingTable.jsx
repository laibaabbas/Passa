...
const BookingTable = ({headings, BookingsData, UpdatingBooking,ApproveBooking,deleting,Approving}) => {
    ...
    <TableContainer component={Paper}>
      <Table sx={{ minWidth: 700 }} aria-label="customized table">
        ...
        <TableBody>
          ...
          {BookingsData?.BookingsCredentials?.map((row, index) => (
            <StyledTableRow key={index}>
              ...
              <StyledTableCell align="center">
              {Approving === row.userId ? (
                  <span className="tble_deleting_text">Approving...</span>
                ) : (
                  <Button
